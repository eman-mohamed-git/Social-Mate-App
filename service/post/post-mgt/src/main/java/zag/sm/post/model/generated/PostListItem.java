...
public class PostListItem implements Serializable {
    ...
    public PostListItem id(Long id) {
        this.id = id;
        return this;
    }
    ...
    public PostListItem content(String content) {
    ...
    public PostListItem createdBy(LightUserVTO createdBy) {
    ...
    public PostListItem createdOn(Date createdOn) {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.id, postListItem.id) && Objects.equals(this.title, postListItem.title)
                && Objects.equals(this.content, postListItem.content)
                && Objects.equals(this.createdBy, postListItem.createdBy)
                && Objects.equals(this.createdOn, postListItem.createdOn);
    }
